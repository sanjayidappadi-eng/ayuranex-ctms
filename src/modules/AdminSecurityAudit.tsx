          ...
          <div className="rounded-3xl bg-slate-900/95 border-2 border-teal-500/50 p-6 space-y-6 shadow-2xl shadow-teal-500/10">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 border-b border-slate-800 pb-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                {isCredentialsLocked ? (
                  <div className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-slate-900 border border-emerald-500/60 text-emerald-300 shadow cursor-not-allowed">
                    <Lock size={14} className="text-emerald-400" />
                    <span>🔒 Credentials Permanently Saved & Locked</span>
                  </div>
                ) : (
                  <button
                    type="button"
                    onClick={() => {
                      ...
                      try {
                        ...
                        alert("🔒 Credentials saved and permanently locked! Re-editing is strictly disallowed to prevent credential tampering.");
                      } catch (err) {
                        console.error(err);
                      }
                    }}
            ...
            {isCredentialsLocked && (
              <div className="p-3.5 rounded-2xl bg-emerald-950/40 border border-emerald-600/50 flex items-center gap-3 text-emerald-200 text-xs">
                <ShieldCheck size={18} className="text-emerald-400 shrink-0" />
                <span className="leading-relaxed">
                  <strong>Security Policy Active:</strong> Both SMS & Email API credentials have been permanently verified and locked into secure storage. Re-editing and modifications cannot be allowed.
                </span>
              </div>
            )}
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950/70 p-4 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, smsProvider: e.target.value as any })}
                    className={`w-full px-3.5 py-2 bg-slate-900 border rounded-xl text-xs text-white focus:outline-none ${
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        value={isCredentialsLocked ? "••••••••••••••••••••••••••••••••" : (notifConfig.twilioAccountSid || "")}
                        onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, twilioAccountSid: e.target.value })}
                        placeholder="ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
                        className={`w-full px-3 py-1.5 bg-slate-900 border rounded-xl text-xs text-white font-mono focus:outline-none ${
                          isCredentialsLocked ? "border-slate-800 opacity-60 cursor-not-allowed" : "border-slate-800 focus:ring-1 focus:ring-teal-400"
                        }`}
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        disabled={isCredentialsLocked}
                        readOnly={isCredentialsLocked}
                        value={isCredentialsLocked ? "••••••••••••••••••••••••••••••••" : (notifConfig.twilioAuthToken || "")}
                        onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, twilioAuthToken: e.target.value })}
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, twilioFromNumber: e.target.value })}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, fast2SmsApiKey: e.target.value })}
                    ...
                    {isCredentialsLocked ? (
                      <p className="text-[10px] text-emerald-400 font-semibold flex items-center gap-1 mt-1">
                        <ShieldCheck size={12} /> Fast2SMS API key permanently saved and locked. Re-editing cannot be allowed.
                      </p>
                    ) : (
                      <p className="text-[10px] text-slate-400 leading-relaxed">
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950/70 p-4 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) => !isCredentialsLocked && setNotifConfig({ ...notifConfig, smtpUser: e.target.value })}
                  ...
                  <div className="mt-2 p-4 rounded-2xl bg-slate-950 border border-teal-500/30 space-y-4 animate-in fade-in">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pb-3 border-b border-slate-800">
                      ...
                      <div className="flex items-center gap-1.5 bg-slate-900 p-1 rounded-xl border border-slate-800">
                        ...
                        <button
                          type="button"
                          disabled={isCredentialsLocked}
                          onClick={() => !isCredentialsLocked && setNotifConfig({ ...notifConfig, smsProvider: "fast2sms" })}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className={`w-full px-3 py-1.5 bg-slate-900 border rounded-lg text-xs text-white font-mono focus:outline-none ${
                              isCredentialsLocked ? "border-slate-800 opacity-60 cursor-not-allowed" : "border-slate-800 focus:ring-1 focus:ring-indigo-400"
                            }`}
                          />
                        ...
                        <div className="space-y-1">
                          ...
                          {isCredentialsLocked ? (
                            <p className="text-[10px] text-emerald-400 font-semibold">
                              ✓ Fast2SMS key permanently saved & locked. Re-editing cannot be allowed.
                            </p>
                          ) : (
                            <p className="text-[10px] text-slate-400">
                      ...
                      <div className="space-y-1">
                        ...
                        {isCredentialsLocked ? (
                          <p className="text-[10px] text-emerald-400 font-semibold">
                            ✓ Gmail App Password permanently saved & locked. Re-editing cannot be allowed.
                          </p>
                        ) : (
                    ...
                    <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-800">
                      {isCredentialsLocked ? (
                        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900 border border-emerald-600/50 text-emerald-300 text-xs font-bold cursor-not-allowed">
                          <Lock size={13} />
                          <span>🔒 Credentials Permanently Saved & Locked</span>
                        </div>
                      ) : (
                        <button
                          ...
                          onClick={() => {
                            ...
                            try {
                              localStorage.setItem("ayuranex_notification_channel_config", JSON.stringify(updated));
                              localStorage.setItem("ayuranex_credentials_locked", "true");
                              alert("🔒 Credentials saved and permanently locked! Re-editing cannot be allowed.");
                        ...
                        >
                          Save & Permanently Lock Credentials
                        </button>
                      )}
                    </div>
                  </div>
