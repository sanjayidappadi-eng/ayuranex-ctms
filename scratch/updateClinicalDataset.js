...
const fullFileContent = tsHeader + generatorCode;
const targetPath = path.resolve("src/data/clinicalDataset.ts");
fs.writeFileSync(targetPath, fullFileContent, "utf-8");
console.log("Successfully generated src/data/clinicalDataset.ts with full clinical cohorts!");
